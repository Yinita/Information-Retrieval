...
def init():
    ...
    return driver
def main(driver, year='2023', unit='党政办公室'):
    ...
    target_folder = "data//"+year+"_"+unit  # path
...
if __name__ == "__main__":
    driver = init()
    main(driver, year='2021', unit='党政办公室')